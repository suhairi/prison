...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="{{ url('images/favicons/favicon-16x16.png') }}" sizes="16x16" type="image/png">
    <link rel="manifest" href="{{ url('images/favicons/manifest.json') }}">
    <link rel="mask-icon" href="{{ url('images/favicons/safari-pinned-tab.svg') }}" color="#7952b3">
    <link rel="icon" href="{{ url('images/favicons/favicon.ico') }}">
...
<header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
  ...
  <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3" href="{{ route('admin.dashboard') }}">
    <img src="{{ url('images/logo.jpg') }}" width="40px" height="45px" />
      &nbsp;
      Prison Kedah
  </a>
